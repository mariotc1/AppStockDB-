"""
Vista principal de la sección 'Baños' en la aplicación de gestión de stock.

Integra múltiples subvistas relacionadas con el mobiliario de baño:
...
:param categoria: Categoría de productos a gestionar (baño).
...
class BathroomView(QWidget):

    """
    Inicializa la vista RoomView con la categoría 'Baños' y construye la interfaz principal.

    :param categoria: Categoría a la que pertenece la vista ('Baños').
    :param parent: Widget padre opcional.
    """
