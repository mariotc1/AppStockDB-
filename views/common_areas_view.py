"""
Vista principal de la sección 'Zonas Comunes' en la aplicación de gestión de stock.

Integra múltiples subvistas relacionadas con el mobiliario de las zonas comunes:
...
:param categoria: Categoría de productos a gestionar (zonas comunes).
...
class CommonAreasView(QWidget):
    ...
    def initUI(self):
        ...
        title = QLabel("Mobiliario de Zonas Comunes")
